...
const HiddenNav = () => {
  ...
  return (
    <AnimatePresence>
      {isNavBarOpen && (
        <motion.div
          className="fixed bottom-[0.8rem] left-[0.8rem] right-[0.8rem] top-[0.8rem] z-[12] rounded-[2rem] bg-[color:var(--warna-putih)] will-change-transform md:left-[unset] md:w-screen md:max-w-[500px]"
